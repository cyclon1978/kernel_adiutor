...
public interface Constants {
  ...
  //Core Control
    String DISABLEBIG = "/sys/devices/system/cpu/cpu4/core_ctl/disable";
    String DISABLELITTLE = "/sys/devices/system/cpu/cpu0/core_ctl/disable";
    ...
    String[] CORECONTROL_ARRAY = {DISABLEBIG, DISABLELITTLE, MINBIG, MINLITTLE, MAXBIG, MAXLITTLE};
  ...
  // CPU Voltage
    ...
    String CLUSTERPLUG_HOTPLUG_LOW_POWER_MODE = CLUSTERPLUG_HOTPLUG + "/low_power_mode";
    String CLUSTERPLUG_HOTPLUG_SAMPLING_TIME = CLUSTERPLUG_HOTPLUG + "/sampling_time";
    String CLUSTERPLUG_HOTPLUG_LOAD_THRESHOLD_UP = CLUSTERPLUG_HOTPLUG + "/load_threshold_up";
    String CLUSTERPLUG_HOTPLUG_LOAD_THRESHOLD_DOWN = CLUSTERPLUG_HOTPLUG + "/load_threshold_down";
    String CLUSTERPLUG_HOTPLUG_VOTE_THRESHOLD_UP = CLUSTERPLUG_HOTPLUG + "/vote_threshold_up";
    String CLUSTERPLUG_HOTPLUG_VOTE_THRESHOLD_DOWN = CLUSTERPLUG_HOTPLUG + "/vote_threshold_down";

    String[] HOTPLUG_CLUSTERPLUG_ARRAY = {CLUSTERPLUG_HOTPLUG};
    ...
    String[][] CPU_HOTPLUG_ARRAY = {{HOTPLUG_MPDEC, MSM_SLEEPER, STATE_HELPER, MSMPERFORMANCE, BCH, HIMA_HOTPLUG}, INTELLIPLUG_ARRAY, BLU_PLUG_ARRAY, HOTPLUG_MSM_ARRAY, MAKO_HOTPLUG_ARRAY,
            MB_HOTPLUG_ARRAY, ALUCARD_HOTPLUG_ARRAY, HOTPLUG_THUNDER_PLUG_ARRAY, HOTPLUG_ZEN_DECISION_ARRAY, HOTPLUG_AUTOSMP_ARRAY, HOTPLUG_LAZYPLUG_ARRAY, HOTPLUG_CLUSTERPLUG_ARRAY, DYN_PLUG_ARRAY, AUTO_HOTPLUG_ARRAY};
